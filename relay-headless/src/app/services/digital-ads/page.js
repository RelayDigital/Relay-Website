...
export default function DigitalAdsPage() {
  ...
  return (
    <div className="relative flex flex-col gap-10 bg-grid-white/[0.05]">
        ...
        <div className="mb-6 mt-12 flex flex-col items-center text-center lg:mb-24 lg:mt-48 lg:grid lg:grid-cols-3">
          <div className="col-span-2 lg:mt-6 lg:mr-4">
            <div className="-z-10 max-w-4xl text-center text-neutral-200 text-3xl sm:text-5xl lg:text-start lg:text-7xl">
              <h1 className="md:bg-gradient-to-br md:from-neutral-100 md:from-55% md:to-neutral-500 md:bg-clip-text font-medium tracking-tight md:text-transparent text-neutral-100 lg:min-h-[20rem]" data-speed="0.5">
                Paid Media That <span className="text-blue-500">Actually</span> Performs
          ...
          <div className="col-span-1 flex flex-col items-start justify-between gap-y-8 py-12 text-start lg:h-full">
            <p className="text-center text-xl leading-tight text-neutral-300 lg:text-start" data-speed="0.7">
              We manage ad spend like it&apos;s our own money. Full-funnel strategy, creative production, and relentless optimization across Meta, Google, TikTok, and programmatic.
            </p>
      ...
      <div className="mx-auto min-w-[75vw] px-6 lg:px-8">
        <dl className="relative z-40 mt-6 grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-neutral-600 bg-neutral-600 text-center shadow-2xl shadow-blue-500/50 lg:grid-cols-4" data-speed="1.05">
          {[
            ...
            { value: "12x", label: "Revenue Multiple" },
          ].map((s) => (
          ...
          <div className="relative flex min-h-[30vh] flex-col items-center justify-center overflow-hidden w-full rounded-md z-0">
            <div className="relative z-50 flex flex-col items-center px-5">
              <h2 className="mt-2 text-3xl font-medium tracking-tight text-white sm:text-6xl text-center capitalize">
                <span className="bg-gradient-to-b from-neutral-50 from-60% to-neutral-400 bg-clip-text text-transparent lg:to-neutral-600">Every Platform. One Strategy.</span>
              </h2>
            </div>
          </div>
            ...
            <div className="mx-auto px-6 lg:max-w-7xl lg:px-8">
              <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                  ...
                  <div className="lg:max-w-lg">
                    <h2 className="mt-2 text-3xl font-medium tracking-tight text-white sm:text-6xl">
                      <span className="bg-gradient-to-b from-neutral-50 from-60% to-neutral-400 bg-clip-text text-transparent lg:to-neutral-600">
                        Full-Funnel{" "}
                        <span className="bg-gradient-to-b from-blue-500 from-60% to-blue-400 bg-clip-text text-transparent lg:to-blue-600 underline">Campaign</span>{" "}
                        Management<span className="text-blue-500">.</span>
                      </span>
                    </h2>
                    <p className="text-md mt-6 font-light text-neutral-300 md:text-lg">
                      From cold prospecting to retargeting to loyalty — we build and manage full-funnel campaigns across Meta, Google, TikTok, and programmatic. Structured testing, daily optimization, creative rotation based on real data.
                    </p>
                    <a href="/contact">
                ...
                <div className="relative flex items-start justify-end">
                  <Image src="/img/increase-cr.webp" alt="Campaign management" className="hidden sm:block right h-auto w-[24rem] max-w-none sm:w-[36rem] md:-ml-4 lg:-ml-0" loading="lazy" width={1217} height={1227} decoding="async" />
                  <Image src="/img/increase-cr.webp" alt="Campaign management" className="block sm:hidden h-auto w-[24rem] max-w-none sm:w-[36rem]" loading="lazy" width={1217} height={1227} decoding="async" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                <div className="lg:ml-auto lg:pl-4 lg:pt-4">
                  <div className="lg:max-w-lg">
                    <h3 className="mt-2 text-3xl font-medium tracking-tight text-white sm:text-6xl">
                      <span className="bg-gradient-to-b from-neutral-50 from-60% to-neutral-400 bg-clip-text text-transparent lg:to-neutral-600">
                        Scroll-Stopping{" "}
                        <span className="bg-gradient-to-b from-blue-500 from-60% to-blue-400 bg-clip-text text-transparent lg:to-blue-600 underline">Creative</span>{" "}
                        & Copy<span className="text-blue-500">.</span>
                      </span>
                    </h3>
                    <p className="text-md mt-6 font-light text-neutral-300 md:text-lg">
                      Great media buying means nothing without great creative. We produce hook-driven ad copy, thumb-stopping visuals, and landing page alignment that gives every dollar of spend a fair shot at converting.
                    </p>
                    <a href="/contact">
                ...
                <div className="relative -ml-5 flex items-start justify-end lg:order-first">
                  <Image src="/img/design.webp" alt="Ad creative" className="hidden sm:block left h-auto w-[28rem] max-w-none sm:w-[40rem] md:-ml-4 lg:-ml-0" loading="lazy" width={1365} height={832} decoding="async" />
                  <Image src="/img/design.webp" alt="Ad creative" className="block sm:hidden h-auto w-[28rem] max-w-none sm:w-[40rem] -mr-24" loading="lazy" width={1365} height={832} decoding="async" />
                </div>
              </div>
            </div>
          </div>
      ...
      <CallToAction header="Stop wasting ad spend." description="Get a free audit of your ad accounts and a clear roadmap to better performance." cta="Get a Free Audit" href="/contact" />
